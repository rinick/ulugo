...
export const shortcutActions: ShortcutAction[] = [
  ...
  {id: 'addTriangle', labelKey: 'addTriangle', defaultShortcut: shortcut('8')},
  {id: 'addCross', labelKey: 'addCross', defaultShortcut: shortcut('9')},
  {id: 'eraseMarkup', labelKey: 'eraseMarkup', defaultShortcut: shortcut('0')},
